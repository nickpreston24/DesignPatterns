...
namespace Shared.MarkupConverters
{
    ...
    internal class HtmlSchema
    {
        ...
        internal static bool IsEmptyElement(string xmlElementName) =>
            ...
            _htmlEmptyElements.Contains(xmlElementName.ToLower());
        ...
        internal static bool ClosesOnParentElementEnd(string xmlElementName) =>
            ...
            _htmlElementsClosingOnParentElementEnd.Contains(xmlElementName.ToLower());
        ...
        private static void InitializeInlineElements() => _htmlInlineElements = new ArrayList
            {
                "a",
                "abbr",
                "acronym",
        ...
        private static void InitializeBlockElements() => _htmlBlockElements = new ArrayList
            {
                "blockquote",
                "body",
                "caption",
        ...
        /// </summary>
        private static void InitializeElementsClosingOnParentElementEnd() => _htmlElementsClosingOnParentElementEnd = new ArrayList
            {
                "body",
                "colgroup",
                "dd",
